...
/**
 * 响应体转换器。负责将响应体转换为期望的实例。
 * <p>适用于 {@link Request#responseBodyConverter()} ，如果直接在上面指定除 {@link AutoResponseBodyConverter} 以外的其他 {@link ResponseBodyConverter}，
 * 那么将不会调用 {@link ResponseBodyConverter#canConvert(HttpResponse, AnnoHttpClientMetadata, ContentType, Charset)}  而是直接开始转换。
 * @author Mara.X.Ma
 * @since 1.0.0 2022-07-19
 * @see Request#responseBodyConverter()
 */
public interface ResponseBodyConverter extends Converter {
